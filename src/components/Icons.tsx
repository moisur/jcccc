...
export const Sparkles = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M11 19l-2-2-2 2"></path>
    <path d="M16 2l-1 2-2 1 2 1 1 2 1-2 2-1-2-1-1-2z"></path>
    <path d="M7 8l-1 2-2 1 2 1 1 2 1-2 2-1-2-1-1-2z"></path>
    <path d="M22 17l-1 2-2 1 2 1 1 2 1-2 2-1-2-1-1-2z"></path>
    <path d="M11 19l-2-2-2 2"></path>
  </svg>
);
...
export const Lightbulb = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9 18h6a2 2 0 0 0 2-2v-4a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v4a2 2 0 0 0 2 2z"></path>
...
export const Brain = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M18.83 14.17C17.48 12.82 15.74 12 14 12c-1.74 0-3.48.82-4.83 2.17"></path>
    <path d="M12 12c2.21 0 4 1.79 4 4s-1.79 4-4 4-4-1.79-4-4 1.79-4 4-4z"></path>
    <path d="M18.83 14.17L22 16"></path>
    <path d="M2 8l3.17 1.83"></path>
    <path d="M12 12L2 8"></path>
    <path d="M12 12L22 16"></path>
  </svg>
);
...
export const Gem = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 3h12l3 7-9 11-9-11 3-7z"></path>
    <path d="M12 16l-7-8 4-4 7 8z"></path>
  </svg>
);
